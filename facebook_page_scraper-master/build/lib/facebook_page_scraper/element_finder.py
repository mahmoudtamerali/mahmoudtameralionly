...
class Finder:
    ...
    def __find_all_posts(driver, layout):
        ...
        try:
            ...
            logger.warning("Cannot find any posts! Exiting!")
                # if this fails to find posts that means, code cannot move forward, as no post is found
            Utilities.__close_driver(driver)
                #sys.exit(1) #to be edited
            return -1
        except Exception as ex:
            logger.warning("Error at find_all_posts method : {}".format(ex))
            Utilities.__close_driver(driver)
                #sys.exit(1) #to be edited
            return -1
    ...
    def __find_name(driver, layout):
        ...
        try:
            ...
            logger.warning("Error at __find_name method : {}".format(ex))
            Utilities.__close_driver(driver)
            return -1
    ...
    def __detect_ui(driver):
        ...
        try:
            ...
            logger.warning("Error art __detect_ui")
            Utilities.__close_driver(driver)
            return -1
                #sys.exit(1) #to be edited
    ...
    def __accept_cookies(driver):
        ...
        try:
            ...
            logger.warning("Error at accept_cookies")
